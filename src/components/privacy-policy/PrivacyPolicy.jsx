        ...
        <div className={`${styles.privacyPolicyContent} `}>
          <div className={`${styles.privacyPolicyContentItem} `}>
            <p>
              ...
              protects any information that you give Snap Exports Pvt Ltd when
            ...
            <p>
              ...
              please write to Snap Exports Pvt. Ltd. 3/2 Shradhanand Marg
              Chawani, Indore 452001 M.P, India.
            </p>
            <p>

    ...
    <div className="container">
      ...
      <div className={`${styles.privacyPolicyContent} `}>
        <div className={`${styles.privacyPolicyContentItem} `}>
          <p>
            This privacy policy sets out how Snap Exports Pvt Ltd uses and
            protects any information that you give Snap Exports Pvt Ltd when you
            use this website.
          </p>
          <p>
            Snap Exports Pvt Ltd is committed to ensuring that your privacy is
          ...
          <p>
            Snap Exports Pvt Ltd may change this policy from time to time by
          ...
          <p>
            ...
            to Snap Exports Pvt. Ltd. 3/2 Shradhanand Marg Chawani, Indore
            452001 M.P, India.
          </p>
          <p>
          ...
          <p>Snap Exports Pvt. Ltd.</p>
          <p>3/2 Shradhanand Marg Chawani, Indore 452001 M.P, India</p>
          <p>+91 8640035758</p>
          <p>info@agriwow.com</p>
        </div>
      </div>
    </div>
  );

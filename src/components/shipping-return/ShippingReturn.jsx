      ...
      <div className={`${styles.shippingReturnContainer} `}>
        ...
        <div className={`${styles.shippingReturnContent} `}>
          <div className={`${styles.shippingReturnContentItem} `}>
            <p>
              1) To ensure that your order reaches you in our standard time (6
              to 12 working days) and in good condition, we will ship through
            ...
            <p>
              ...
              confirm your order (For perfect delivery our executive will
              confirm you your exact delivery address and pin code). If your
              Pincode is not serviceable or we are not able to send the material
              then, you have to give us another address and pin code.
            </p>
            <p>
              ...
              package, click some pictures of the package and write instruction
              to courier boy (The package is tampered or damaged in courier so,
              I will not accept the order) and send us a mail at
              info@agriwow.com mentioning your order reference number and
              attached pictures or call our Customer Care. We shall make our
              best efforts to ensure that a replacement delivery is made to you
              at the earliest.
            </p>
            <p>

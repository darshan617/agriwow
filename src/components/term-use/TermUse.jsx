...
const TermUse = () => {
  return (
    <div className="container">
      <div className={`${styles.breadcrumbHead} `}>
        <h1>Terms of Use</h1>
      </div>
        ...
        <div className={`${styles.termUseContentItem} `}>
          <ul>
            <li>
              ...
              privacy policy govern “Snap Exports Pvt. Ltd.” relationship with
              you in relation to this website.
            </li>
          </ul>
          <p>
            The term “Snap Exports Pvt. Ltd.” or ‘us’ or ‘we’ refers to the
            owner company of the website whose registered office is Snap Exports
            Pvt. Ltd. 3/2, Shradhanand Marg Chawani, Indore – 452001 M.P, India.
          ...
          <p>
            ...
            document without Snap Exports Pvt Ltd prior written consent.
          </p>
          <p>
          ...
          <p><b>all disputes are subject to Indore jurisdiction only</b></p>
          <p><i>* The above terms and conditions may change anytime with or without prior notice. </i></p>
        </div>
      </div>
    </div>
  );

        ...
        <div className={`${styles.termUseContent} `}>
          <div className={`${styles.termUseContentItem} `}>
            ...
            <p>
              ...
              owner company of the website whose registered office is Snap
              Exports Pvt. Ltd. 3/2, Shradhanand Marg Chawani, Indore – 452001
              M.P, India. The term ‘you’ refers to the user or viewer of our
              website.
            </p>
            <p>
            ...
            <p>
              <b>all disputes are subject to Indore jurisdiction only</b>
            </p>
            <p>
              <i>
                * The above terms and conditions may change anytime with or

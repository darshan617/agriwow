      ...
      <div className={`${styles.cancellationReturnContent} `}>
        <div className={`${styles.cancellationReturnContentItem} `}>
          <p>
            ...
            <ul>
              <li>
                If a customer changes their mind and wants to cancel the order,
                then they have to contact our Customer Care executive. The
                cancellation will not be valid until it is confirmed by our
                respective department.
              </li>
              <li>
                Cancellation requests will be considered only if the product is
                not dispatched. Once the order is shipped, customer cannot
                cancel the order.
              </li>
              <li>
          ...
          <p>
            ...
            <ul>
              <li>
                ...
                days of placing an order. (If the product is damaged, Duplicate
                or quantity varies).
              </li>
          ...
          <p>
            ...
            ordering) and optionally tell us why you’re requesting a refund – we
            ...
            comes back to hub. Once the refund is processed we will intimate you
            through EMAIL and SMS with the refund transaction details.
          </p>
          <p>
          ...
          <p>
            <b>
              ...
              invoice. Only when the product will reach premises we will refund
              you your amount as decided.
            </b>
          </p>
          <p>
            <b>
              NOTE : For a refund, the name of the customer must be the same as
              registered Agriwow account name and bank account name, Customer
              must send a Cheque photo or passbook photo for a refund with
          ...
          <p>
            Kindly note that refund will be made only after proper investigation
            of the whole scenario by our special team.
          </p>
          <p>
            <b>Snap Exports Pvt. Ltd.</b> reserve the rights to change or update the
            terms and conditions at any time with or without any prior notice.
            To make sure you are always updated of the terms and conditions,
            please review this website periodically.
          </p>
          <p>Disputes shall be subject to exclusive jurisdiction of the courts of  Indore M.P. </p>
        </div>
      </div>
    </div>
  );

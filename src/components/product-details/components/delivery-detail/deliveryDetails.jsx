...
const price = "2,150.00";
const oldPrice = "4,000.00";
  ...
  return (
    <div className={`${styles.ddCard}`}>
      <div className={`${styles.ddPriceSection}`}>
        <div className={`${styles.ddBadge}`}>46% OFF</div>
        ...
        <button className={`${styles.ddBtnCart}`}>Add to Cart</button>
        <button className={`${styles.ddBtnBuy}`}>Buy Now</button>
        <button className={`${styles.ddBtnWhatsapp}`}>
        ...
        <div className={`${styles.ddSecureIcon} d-flex  gap-2`}>
          <Image src={secureIcon} alt="secure" width={12} height={12} className={`${styles.ddSecureIconImg}`} />
      ...
      <div className={`${styles.ddDeliveryPanel}`}>
        ...
        {infoItems(pincode).map((item, i) => (
          <div key={i} className={`${styles.ddInfoItem}`}>
            <div className={`${styles.ddInfoIcon}`}>{item.icon}</div>
            <div>
              <div className={`${styles.ddInfoTitle} ${item.colorClass}`}>
                {item.title}
              </div>
              {item.desc && (
